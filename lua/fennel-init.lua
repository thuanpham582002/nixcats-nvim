...
local fennel_path = config_dir..sep.."fnl"..sep..phold
require("fnFinder").installFennel(nil, {
    search_opts = {
        path = function(fp) return fennel_path..".fnl"..psep..fennel_path..sep.."init.fnl"..psep..fp end,
        -- set_global = true
    }
})
